...
//	3. todo: Еще рассказать про final
	...
	//дженерик комната которая должна принимать сотрудников (дев опс) (айти) (администрация)
//	Должна быть возможность зарегестрировать разу несколько работников
//	Добавить класс валидатор, который будет проверять не достигнуто ли максимальное количество
//	работников. Если количество работников превышено, должен быть выброшен эксепшен из класса
//	валидатора и успешно обработан в мете проверки количества работников.
